...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XRI Buttons"",
            ""id"": ""a8dd369f-0b08-4db7-b098-af94d31c047b"",
            ""actions"": [
                {
                    ""name"": ""X"",
                    ""type"": ""Button"",
                    ""id"": ""316e4b1b-4f56-45e4-8fe7-9514f533acd7"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Y"",
                    ""type"": ""Button"",
                    ""id"": ""4e2435d8-9e84-4020-80e3-b6bc6b4cf56a"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""A"",
                    ""type"": ""Button"",
                    ""id"": ""187cba34-59f4-42a5-a44b-4be407275cdd"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""B"",
                    ""type"": ""Button"",
                    ""id"": ""1b003c8e-ecf8-4f06-baf9-5f66bdb96d73"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""97748a03-3091-4f16-80ef-57225472913d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1f2533a5-6331-42a9-a3bf-8312438a591f"",
                ...
                {
                    ""name"": """",
                    ""id"": ""fd9a770d-b2d9-486a-8b6c-2c0a35d853e2"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1aa4bd7a-b0ac-437f-97ad-47c433a4b1cb"",
    ...
    ""controlSchemes"": [
        ...
        m_XRIButtons_X = m_XRIButtons.FindAction("X", throwIfNotFound: true);
        m_XRIButtons_Y = m_XRIButtons.FindAction("Y", throwIfNotFound: true);
        m_XRIButtons_A = m_XRIButtons.FindAction("A", throwIfNotFound: true);
        m_XRIButtons_B = m_XRIButtons.FindAction("B", throwIfNotFound: true);
    }
    ...
    private List<IXRIButtonsActions> m_XRIButtonsActionsCallbackInterfaces = new List<IXRIButtonsActions>();
    private readonly InputAction m_XRIButtons_X;
    private readonly InputAction m_XRIButtons_Y;
    private readonly InputAction m_XRIButtons_A;
    private readonly InputAction m_XRIButtons_B;
    public struct XRIButtonsActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public XRIButtonsActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @X => m_Wrapper.m_XRIButtons_X;
        public InputAction @Y => m_Wrapper.m_XRIButtons_Y;
        public InputAction @A => m_Wrapper.m_XRIButtons_A;
        public InputAction @B => m_Wrapper.m_XRIButtons_B;
        ...
        public void AddCallbacks(IXRIButtonsActions instance)
        {
            if (instance == null || m_Wrapper.m_XRIButtonsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_XRIButtonsActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IXRIButtonsActions instance)
        {
            @X.started -= instance.OnX;
            @X.performed -= instance.OnX;
            @X.canceled -= instance.OnX;
        ...
        public void RemoveCallbacks(IXRIButtonsActions instance)
        {
            if (m_Wrapper.m_XRIButtonsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IXRIButtonsActions instance)
        {
            foreach (var item in m_Wrapper.m_XRIButtonsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_XRIButtonsActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
